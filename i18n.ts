...
const resources = {
    ...
    translation: {
      ...
      dashboard: {
        hero: {
          ...
          subtitle:
            'Upload a drawing, an image, or simply describe it - CADLift infers closed regions and exports clean solids.',
  ...
  tr: {
    translation: {
      ...
      home: {
        hero: {
          badge: 'Motor çevrimiçi v1.0',
          title_build: 'Derinliği',
          title_accent: 'Hızlı',
          title_suffix: 'Kurun.',
          subtitle:
            'Manuel ekstrüzyonu bırakın. Ham DXF dosyalarınızı yükleyin, geometri motoru saniyeler içinde 3D katı oluştursun.',
          primaryCta: 'Başla',
      ...
      dashboard: {
        hero: {
          ...
          subtitle:
            'Çizimi yükleyin, bir görüntü gönderin ya da sadece anlatın - CADLift kapalı bölgeleri bulur ve temiz katılar oluşturur.',
